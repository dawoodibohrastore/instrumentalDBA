...
export interface Instrumental {
  ...
  thumbnail: string | null;  // Thumbnail image URL (fallback to gradient if not provided)
...
export const useAppStore = create<AppState>((set, get) => ({
  ...
  stopPreview: async () => {
    ...
    // Don't clear currentTrack here - let the UI decide when to clear it
    // This allows the "Preview Ended" modal to show properly
    set({ isPlaying: false, isPreviewMode: false });
  },
